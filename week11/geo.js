...
async function main() {
   ...
   await loader.load( '../assets/dog.glb',  function ( model ) {
	cat = model;
    ...
    function setupObjects(longitude, latitude) {
        ...
        if(cat) {
          const clonedCat1 = cat.scene.clone();
          const clonedCat2 = cat.scene.clone();
          arjs.add(clonedCat1, longitude - 0.001, latitude);
          arjs.add(clonedCat2, longitude + 0.001, latitude);
        }
      }
